    ...
    <body>
        <%
            ...
            if ((contentType != null) && (contentType.indexOf("multipart/form-data") >= 0)) {
                ...
                String savePart = "D:\\CALGON\\UPLOADS\\PART\\" + saveFile;
                System.out.println("request = " + request.getSession().getServletContext());
                String savePart1 = "D:\\glassfishv4\\glassfish\\domains\\domain1\\applications\\CALGON_UPLOADS\\UPLOADS\\PART\\" + saveFile;
                ...
                out.println("<br><img src='http://cgc-rv016.dyndns.org:8091/CALGON_UPLOADS/UPLOADS/PART/" + saveFile + "' width='50%' height='50%'><br>");
